<x-admin-layout :title="'Tambah Soal'">
    ...
    <div class="mb-5 rounded-3xl border border-gray-200 bg-gradient-to-r from-slate-950 to-slate-800 p-5 text-white shadow-sm dark:border-gray-700">
        ...
        <p class="mt-1 text-sm text-slate-200">Tambahkan soal baru beserta bobot dan kunci jawaban.</p>
    </div>

    <form method="POST" action="{{ route('dosen.ujian.soal.store', $ujian) }}" class="space-y-6">
        @csrf
        ...
        <section class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="pertanyaan" rows="5" class="w-full rounded-2xl border-gray-300 bg-white text-sm dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100">{{ old('pertanyaan') }}</textarea>
        ...
        <div class="sticky bottom-3 z-20 rounded-2xl border border-gray-200 bg-white/90 p-3 shadow-lg backdrop-blur dark:border-gray-700 dark:bg-gray-800/90">
            <div class="flex items-center justify-between gap-3">
                ...
                <button type="submit" class="rounded-2xl bg-slate-950 px-6 py-2.5 text-sm font-semibold text-amber-300 shadow-sm">Simpan Soal</button>
            </div>
        </div>
    </form>
